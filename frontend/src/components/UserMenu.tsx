/* ──────────────────────────────────────────────────────────────────────────
   UserMenu — auth UI for the sidebar.

   • Unauthenticated: "Login with Discord" button
   • Authenticated: user avatar, username, and logout option
   ────────────────────────────────────────────────────────────────────────── */
...
export default function UserMenu() {
  ...
  if (!authenticated || !user) {
    return (
      <div className="auth-section">
        <button className="discord-login-btn" onClick={login} id="discord-login-btn">
    ...
    <div className="auth-section" ref={menuRef}>
      ...
      >
        ...
        <div className="user-profile-info">
          ...
          <span className="user-profile-badge">Authenticated</span>
        </div>
        <svg
          className={`user-menu-chevron ${menuOpen ? "open" : ""}`}
          width="12"
          height="12"
          viewBox="0 0 12 12"
          fill="none"
